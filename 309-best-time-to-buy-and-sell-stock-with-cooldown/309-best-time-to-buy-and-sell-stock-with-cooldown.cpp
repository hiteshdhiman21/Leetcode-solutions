...
public:
    int maxProfit(vector<int>& prices) {      
      ...
      /*Buy[i] denotes some stock is buyed on day <= i and what is max net profit after keeping some stock(Most profitable priced stock).
        Sell[i] denotes net profit after not keeping any stock on day i. It means not buying any stock on this day, if there is no kept stock or just 
                selling the most profitable kept stock price on this day*/
        int n = prices.size();
